...
const Header = () => {
    ...
    return(
        <header className="xl:sticky xl:top-0 flex flex-col xl:max-h-screen xl:w-1/2 xl:flex-col xl:justify-between xl:py-24 justify-between gap-5 xl:items-start">
