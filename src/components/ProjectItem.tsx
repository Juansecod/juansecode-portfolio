        ...
        <li className="flex flex-col lg:flex-row gap-2 p-2 lg:p-4 transition-all sm:gap-8 md:gap-4 lg:hover:bg-slate-950 lg:hover:bg-opacity-50  rounded">
            ...
            {modalDisplay && 
                (<div className="w-screen h-screen bg-slate-950 bg-opacity-50 fixed top-0 left-0 z-50 px-2 lg:py-20 lg:px-20 flex items-center justify-center flex-col lg:pb-5" onClick={handleModal}>
                    <div className="max-w-[1440px] flex items-center justify-center flex-col gap-2">
                        ...
                        <Image src={image} alt={"Preview " + name} title={"Preview " + name} className="rounded lg:h-full lg:w-auto aspect-video" onClick={stopPropagation} />
                    </div>
                </div>)
            }
